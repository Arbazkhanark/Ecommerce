...
//                 <h2 className=" font-extrabold text-4xl">Join the Anime Revolution! <br/> Sign Up Today!</h2>
//             </div>
//             <div className="form">
//                 <form>
//                     <label>Name</label>
      ...
      <>
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <img
              className="mx-auto logo-img w-32"
              src="/logo.png"
              alt="Your Company"
            />
            <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
            Join the Anime Revolution! <br/> Sign Up Today!
            </h2>
          </div>
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            Already part of our anime community ?{' '}
